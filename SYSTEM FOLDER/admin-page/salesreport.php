...
while ($row = $result->fetch_assoc()) {
    ...
    $totalBookings += $row['service_count'];  
}

$servicesQuery = "SELECT id, name FROM services WHERE status = 0"; 
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content">
			...
			<div class="container-fluid" id="reportcontents">
					...
					<div class="col-lg-6 col-xl-6 mb-4">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Service Overview</h6>
							</div>
							<div class="card-body">
								<?php foreach ($services as $serviceId => $serviceName): ?>
									...
									<div class="progress mb-4">
										<div class="progress-bar" role="progressbar" style="width: <?php echo $servicePercentages[$serviceId]; ?>%" aria-valuenow="
										<?php echo round($servicePercentages[$serviceId], 2); ?>" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								<?php endforeach; ?>
							</div>
						</div>
				...
				<div class="btn-box">		
					<button class="submitbutton" id="print">Download PDF</button>
				</div>
			</div>
		</div>
