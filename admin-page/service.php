...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>window.location.href='service.php';</script>"; // Redirect after deletion
    } else {
        echo "<script>alert('Error deleting service.'); window.location.href='service.php';</script>";
    }
    $stmt->close();
}
                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-primary btn-add" onclick="window.location.href='addservice.php';">Add</button>
                                </div>
                                <div class="card-body">
